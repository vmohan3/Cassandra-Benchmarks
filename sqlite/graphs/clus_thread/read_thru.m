x = dlmread('clus_thread_read_thru.csv', '|')
clusters = [1,2,4,8]
clusters = clusters'
...
title(' READ Throughput vs # Client Threads vs Cluster Size.  Value size = 1024 bytes')

print -dpng clussize_thread_read_thru.png
